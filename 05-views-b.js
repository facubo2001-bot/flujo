...
function viewCartera() {
  ...
  html += `<div class="grid g-kpi">
    ...
    ${kpi({ label: 'Dividendos cobrados', value: fmtU(k.dividendos),
      stats: [{ k: 'En caja', v: k.dividendos ? (k.caja > 0.005 ? fmtU(k.caja, 2) : 'reinvertidos') : '—' }, { k: 'S/ costo', v: k.costo && k.dividendos ? M.pct(k.dividendos / k.costo, 1) : '—' }],
